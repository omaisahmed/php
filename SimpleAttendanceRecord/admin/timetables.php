	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:110px;">
			<ul class = "nav nav-pills">
				...
				<li class = "active"><a href = "timetables.php"><span class = "glyphicon glyphicon-book"></span> Timetables</a></li>
				<li><a href = "generate_timetable.php"><span class = "glyphicon glyphicon-plus-sign"></span> Create Timetable</a></li>
			</ul>
			<br />
			<div class = "alert alert-info">Time Tables</div>
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-primary">
						<div class = "modal-header panel-heading">
							...
							<h4 class = "modal-title" id = "myModallabel">Add new Time Table</h4>
						</div>
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
							<div class  = "modal-body">
								...
								<div class = "form-group">
									...
									<input type = "text" name = "createdby" value="Mohsin Ishtiaq" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Create Date</label>
									<input type = "date" name = "createdate" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Status</label>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $f_student['title']?></td>
							<td><?php echo $f_student['description']?></td>
							<td><?php echo $f_student['createdby']?></td>
							<td><?php echo $f_student['createdate']?></td>
							<td><?php echo $f_student['status']?></td>
		...
		$(document).ready(function(){
			$('.rstudent_id').click(function(){
				...
				$('.remove_id').click(function(){
					window.location = 'delete_student.php?sno=' + $student_id;
				});
			});
			$('.estudent_id').click(function(){
				$student_id = $(this).attr('name');
				$('#edit_query').load('load_edit1.php?sno=' + $student_id);
			});
		});
	</script>
</html>