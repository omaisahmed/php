...
<?php
$connect=mysqli_connect("localhost","root","","shoppingsite");
...
?>
						...
						<?php echo"<div id='myCarousel' class='myCarousel carousel slide'>
											...
											<ul class='thumbnails'>												
												<li class='span3'>
													<div class='product-box'>
														...
														<p><a href='product_detail.php?image=$f'><img src='$f' alt='' /></a></p>
														<a href='product_detail.php' class='title'>$c</a><br/>
														<a href='product_detail.php' class='category'>$b</a>
														<p class='price'>$e</p>
													</div>
												</li>																											
											</ul>
