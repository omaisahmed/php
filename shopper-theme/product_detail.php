			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
							<?php echo "<a href='$img' class='thumbnail' data-fancybox-group='group1' title='Description 1'><img alt='' src='$img'></a>												
...
?>
							<div class="span5">
								<address>
									<strong>Product Name:</strong> <span><?php echo "$b" ?></span><br>
									<strong>Product Qty:</strong> <span><?php echo "$d" ?></span><br>
									<strong>Product Detail:</strong> <span><?php echo "$c" ?></span><br>
									<strong>Availability:</strong> <span>Out Of Stock</span><br>								
								</address>									
								<h4><strong><?php echo "$e"; ?></strong></h4>
							</div>
							<div class="span5">
								...
								<?php echo"<button class='btn btn-inverse' type='submit'><a href='cart.php?pid=$a&qty=$q'>Add to cart</a></button>"; ?>
								</form>
							</div>							
						</div>
