...
<html lang = "eng">
	...
	<body background="images/background-login.jpg">
		...
		<div class = "navbar navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "pull-left" style="color: white;">&copy; Attendance Management System 2019</label>
				<label class = "pull-right" style="color: white;">Developer: Omais Ahmed Khan</a></label>
			</div>	
		</div>
	</body>
