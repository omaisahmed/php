...
$sql="select * from products where pcategory='formal'";
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>SHOES STORE  |  FORMAL SHOES</title>
...
<ul>
                ...
                <li><a class="active" href="#news">FORMAL SHOES</a></li>
...
<div class="cat-product">
    <h3 class="cat-heading">Formal Shoes</h3>
<?php
